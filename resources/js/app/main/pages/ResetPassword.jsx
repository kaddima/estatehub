    ...
    <div className='h-full md:flex items-center justify-center px-3 md:px-0'>
        <div className='max-w-[450px] mx-auto md:mx-0'>
            <div className='text-center mb-5'>
                ...
                <p className='text-sm'>Your new password should be different from your old password</p>
                <div id='reset-success' className='hidden my-3 text-green-700 font-semibold'>
            ...
            <div>
                <form action="" className='space-y-4'>
                    <div>
                        <Input type={'password'} register={register} id={'password'} errors={errors}
                         valObj={{
                            required:"please enter password", 
                            minLength:{value:6,message:"Password too short"}}} 
                        label={'New Password'} className={'bg-transparent border'}/>
                        {errors.password && (
                            <p className="text-red-400 text-sm">{errors.password.message}</p>
                        )}
                    </div>
                    <div>
                        <Input type={'password'} register={register} id={'c_password'} errors={errors}
                         valObj={{
