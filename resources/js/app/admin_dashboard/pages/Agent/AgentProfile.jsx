...
const AgentProfile = () => {
  ...
  return (
    <div className='bg-white h-full text-black/90 text-sm p-5 overflow-scroll'>
        ...
        {userDetails?.first_name ? ( <div className=''>
            <div className='md:w-3/5'>
                <div>
                    ...
                    (<div className='h-[110px] border border-dashed border-black/60 rounded flex justify-center items-center'>
                        <div className='text-center text-lg font-bold'>
                            <h1>Agent has no image</h1>
                            <p className='text-sm font-normal'>The agents image shows here if they upload one</p>
                        </div>
