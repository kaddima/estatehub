...
const PropertyDetails = () => {
  ...
  return (
    <div className="bg-white relative w-full h-full overflow-auto" id='property'>
        {currentUser.id == propertyDetails?.creator_id && <div className='fixed bottom-3 right-3 bg-sky-800 text-white font-[400] rounded'>
        ...
        <div className='mt-[2px] md:w-10/12 mx-auto px-3 md:px-0'>
            ...
            <div className='mt-5 max-w-[800px]' id='overview'>
                ...
                <div className='mt-5' >
                    ...
                    <div className='flex md:flex-row flex-col flex-wrap md:items-center md:space-x-10 border-b mt-5 pb-5'>
                        <div>
