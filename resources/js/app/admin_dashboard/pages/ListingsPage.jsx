...
const ListingsPage = () => {
  ...
  return (
    <div className='h-full w-full overflow-scroll relative bg-white'>
        <div className='sticky top-[-5px] bg-white z-[10] flex my-[4px] items-center rounded-xl'>
                ...
                <h1 className='text-sm font-semibold'>Listings</h1>
                 <ul className='flex gap-2 mt-3'>
                    <li className='text-sm w-full'>
                        <button data-type='all' onClick={setListingType} className={`${searchParams.get('list-type') == 'all' && 'border-white bg-black text-white'} flex items-center py-1 px-2 border rounded-lg`}>
                            <MdOutlineBarChart size={16}/>
                            <span className='inline-block ml-1'>All</span> 
                        </button>   
                    </li>
                    <li className='text-sm w-full'>
                        <button data-type='currentuser' onClick={setListingType} className={`${searchParams.get('list-type') == 'currentuser' && 'border-white bg-black text-white'} flex items-center py-1 px-2 border rounded-lg`}>
